...
class Soldier(pygame.sprite.Sprite):
	def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
		...
		self.speed = speed
		self.ammo = ammo
		# self.ammo = ammo  -  reduce everytime I shoot
		...
		# time when animation was last time updated
	...
	def update_action(self, new_action):
		# check if the new action if different to the previous one
	...
	def draw(self):
		# screen.blit(self.image, self.rect) было до введения flip (== разворот картинки, лицо влево/вправо)
		# здесь пишем self вместо имени экземпляра класса в коде за пределами класса
...
class Explosion(pygame.sprite.Sprite):
	...
	def update(self):
		...
		if self.counter >= EXPLOSION_SPEED:
			self.counter = 0
			self.frame_index += 1
			# if the animation is complete than delete the explosion
